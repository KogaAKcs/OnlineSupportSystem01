...
<jsp:useBean id="testData" class="ossServletControl.CategoryControl" scope="request" />
...
<ul>
<form name="CategoryControl" action="CategoryControl" method="post">
<% for(Object item : listData){
	OSSmainPackage.Category dc = (OSSmainPackage.Category)item; %>
  <input type="hidden" name="getなんたら" value="<% out.print(dc.getName()); %>">
  	  <li><a href="javascript:CategoryControl.submit()"><% out.print(dc.getName()); %><% } %></a></li>
  <li>基本情報</li>
  <li>基本情報</li>
