...
<br>
  ...
  <div class="item">
    <label class="label">３.解答を作成してください</label>
    <br>
    <input class="inputs" type="text1" name="answer">
  </div>
<div class='button8'><a href="" class="btn btn--white1">下書きに保存してキャンセル</a>
 	                 ...
 	                 <a href="" class="btn btn--white2">作成完了！</a>
 	                 </div>
</form>
